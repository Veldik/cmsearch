<head>
  <meta charset="UTF-8">
  <title>Vyhledávač CraftManie</title>
  ...
  <meta name="description" content="Jednoduchý a neoficiální nástroj na vyhledávání dat z apiny CraftManie.">
...
<article>
  <center>
    <h1>
      Vyhledávač CraftManie
    <h1>
    <h2>
      Jednoduchý a neoficiální nástroj na vyhledávání základních informací o hráčích na craftmanii.
    </h2>
  ...
  <h1>
    Generování CraftMania bannerů
  <h1>
  <h2>
    Jednoduchý a neoficiální nástroj na generování bannerů se základními informacemi o hráčích na craftmanii.
  </h2>
<form method="GET" action="/cm/banner/index.php">
  <input type="text" name="nick" placeholder="Nick">
  <input type="submit" value="Generovat!">
</form>
<h1>
  Porovnávání hráčů hrajících na CraftManii
<h1>
<h2>
  Jednoduchý a neoficiální nástroj na porovnání dvou hráčů hrajících na CraftManii.
</h2>
<form method="get" action="/cm/comparison.php">
  <input type="text" name="nick1" placeholder="Nick1">
  <input type="text" name="nick2" placeholder="Nick2"> <input type="submit" value="Vyhledat">
</form>
  <h1>
    AdminTeam:
  </h1>
